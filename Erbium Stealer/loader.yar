rule Erbium_Loader
{
    meta:
        ...
        modified        = "2022-09-02"
        reference       = "https://tria.ge/220901-136gasbhdm/behavioral2"
        tlp             = "TLP:WHITE"
    ...
    strings:
        ...
        $x6 = { 6800800000 6a00 8b55f8 52 8b4508 50 ff55?? 6800800000 6a00 8b4df0 51 8b5508 52 ff55?? 6800800000 6a00 8b45e8 50 8b4d08 51 ff55?? 32c0 eb0c }
